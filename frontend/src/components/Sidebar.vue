<template>
    <div :class="{ 'sidebar-open': visible, 'sidebar-close': !visible }">
        <div class="card flex justify-content-center">
            ...
            <Button class="button-wrapper" icon="pi pi-bars" @click="visible = true" />
            <!-- Konten Utama -->
            <div :class="{ 'content-with-sidebar': visible, 'content-full': !visible }">
                <Button class="button-wrapper" icon="pi pi-bars" @click="visible = true" />
